...
// Function to iterate through student folders for HW3
            ...
            if (studentFolder.isDirectory()) {
                ...
                if (fs.existsSync(indexHtmlPath)) {
                    ...
                    if (fs.existsSync(styleCssPath)) {
                        ...
                        // Run tests for HW3
                        console.log(`Running tests for ${studentName} on HW3`);
                        exec(`npx jest scripthw3.test.js`, (error, stdout, stderr) => {
                            if (error) {
                                console.error(`Error running tests for ${studentName} on HW3:`, error);
                                return;
                            }
                            console.log(`Test results for ${studentName} on HW3: successful\n`);
