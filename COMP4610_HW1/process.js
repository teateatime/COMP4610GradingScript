...
// Function to iterate through student folders
            ...
            if (studentFolder.isDirectory()) {
                ...
                if (fs.existsSync(indexHtmlPath)) {
                    ...
                    if (fs.existsSync(styleCssPath)) {
                        ...
                        exec(`npx jest scripthw1.test.js`, (error, stdout, stderr) => {
                            if (error) {
                                console.error(`Error running tests for ${studentName}:`, error);
                                return;
                            }
                            console.log(`Test results for ${studentName}: successful\n`);
