...
// Function to iterate through student folders for HW4
            ...
            if (studentFolder.isDirectory()) {
                ...
                if (fs.existsSync(indexHtmlPath)) {
                    ...
                    if (fs.existsSync(styleCssPath)) {
                        ...
                        // Run tests for HW4
                        console.log(`Running tests for ${studentName} on HW4`);
                        exec(`npx jest scripthw4.test.js`, (error, stdout, stderr) => {
                            if (error) {
                                console.error(`Error running tests for ${studentName} on HW4:`, error);
                                return;
                            }
                            console.log(`Test results for ${studentName} on HW4: successful\n`);
